...
public class Applications {
    ...
    public static void addApplication(Context mContext, VetnoteAppInfo app, int dpi) {
    ...
    public static VetnoteAppInfo[] getApplicationList(Context mContext, int dpi) {
        ...
        try {
            ...
            properties.load(new FileInputStream("/system/etc/vetnote/properties.conf"));
        } catch (Throwable t) {
    ...
    public static VetnoteAppInfo[] getApplicationList(Context mContext) {
        ...
        VetnoteAppInfo[] items = new VetnoteAppInfo[mPackageList == null ? 0 : mPackageList.size()];
    ...
    private static VetnoteAppInfo findAppInfo(Context mContext, String packageName) {
